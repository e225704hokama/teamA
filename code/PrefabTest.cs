...
public class PrefabTest : MonoBehaviour {
    ...
    */
    ...
    private void DoSomething()
    {
        ...
        int randomValue = UnityEngine.Random.Range(0, 4); // 0から2までのランダムな整数値を取得する


        GameObject obj = (GameObject)Resources.Load ("coin");
        GameObject obj2 = (GameObject)Resources.Load ("bomb");
        ...
        switch (randomValue)
            {
                ...
                case 3:
                    // valueが0の場合の処理
                    //Instantiate (obj, new Vector3(11.0f,-11.5f,0.0f), Quaternion.identity);
                    Instantiate (obj2, new Vector3(11.0f,-11.5f,0.0f), Quaternion.identity);
                    Debug.Log("///////////////////////////////////////");
                    break;
                case 4:
                    // valueが1の場合の処理
                    //Instantiate (obj, new Vector3(11.0f,-8.5f,0.0f), Quaternion.identity);
                    Debug.Log("////////////////////////////////////////////////////////////////");
                    Instantiate (obj2, new Vector3(11.0f,-8.5f,0.0f), Quaternion.identity);
                    break;
                case 5:
                    // valueが2の場合の処理
                    Instantiate (obj2, new Vector3(11.0f,-5.5f,0.0f), Quaternion.identity);
                    Debug.Log("//////////////////////////////////////////////");
                    break;
                default:
